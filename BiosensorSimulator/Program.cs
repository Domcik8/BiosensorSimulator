...
namespace BiosensorSimulator
{
    class Program
    {
        static void Main()
        {
            ...
            var biosensor = new TwoLayerPerforatedMembraneBiosensor2D();
            ...
            BaseSimulation2D simulation = new LayerSimulation2D(simulationParameters, biosensor, resultPrinter);
            ...
            else
            {
                ...
                new ExplicitSchemeStabilityChecker2D().AssertStability(simulationParameters, biosensor);
            }
